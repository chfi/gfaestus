...
impl RenderPasses {
    pub fn create(
        ...
        let offscreen = Self::create_offscreen(
            device,
            swapchain_props,
            vk::Format::R8G8B8A8_UNORM,
        )?;
        let offscreen_msaa = Self::create_offscreen_msaa(
            device,
            swapchain_props,
            vk::Format::R8G8B8A8_UNORM,
            msaa_samples,
        )?;
        let gui = Self::create_offscreen_msaa(
            device,
            swapchain_props,
    ...
    pub fn recreate(
        ...
        self.offscreen_msaa = offscreen_msaa;
        self.gui = gui;
    ...
    pub fn destroy(&self, device: &Device) {
        unsafe {
            ...
            device.destroy_render_pass(self.offscreen, None);
            device.destroy_render_pass(self.offscreen_msaa, None);

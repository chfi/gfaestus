...
use super::super::{create_shader_module, read_shader_from_file};
...
pub struct NodeThemePipeline {
    ...
    pub(crate) background_color: rgb::RGB<f32>,
...
impl NodeThemePipeline {
    ...
    pub fn new(
        ...
        Ok(Self {
            ...
            background_color: rgb::RGB::new(1.0, 1.0, 1.0),
